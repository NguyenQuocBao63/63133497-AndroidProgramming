...
public class ListQuizzes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(oper.equals("List Solved Quizzes")){
            ...
            showGrade = false;
            createdQuizzes  = true;
        }else if (oper.equals("List Quiz Grade")){
            ...
            ValueEventListener listener = new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot f : ds.getChildren()){
                        ids.add(f.getKey());
                        data.add(snapshot.child("Quizzes").child(f.getKey())
                                .child("Title").getValue().toString());
                    }
                }
                @Override
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(ListQuizzes.this, "Cann't connect", Toast.LENGTH_SHORT).show();
                }
            };
            ...
            ValueEventListener listener = new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot f : ds.getChildren()){
                        ...
                        String points = snapshot.child("Quizzes").child(quizID).child("Answers")
                                .child(f.getKey()).child("Points").getValue().toString();
                        String total = snapshot.child("Quizzes").child(quizID)
                                .child("Total Question").getValue().toString();
