...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button start_Quiz = findViewById(R.id.startQuiz);
        Button create_Quiz = findViewById(R.id.createQuiz);
        ...
        ValueEventListener listener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (usersRef.hasChild("Total Point")){
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Home.this, "Cann't connect", Toast.LENGTH_SHORT).show();
            }
        };
        ...
        create_Quiz.setOnClickListener(v -> {
